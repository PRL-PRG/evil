...
create_call_row <- function(eval_call_id = integer(0),
                            ...
                            caller_stack_expression = character(0),
                            caller_stack_expression_raw = character(0),
                            caller_stack_expression_srcref = character(0),
                            ...
                            direct_builtin = integer(0),
                            indirect_builtin = integer(0),
                            direct_special = integer(0),
                            indirect_special = integer(0),
                            direct_closure = integer(0),
                            indirect_closure = integer(0),
                            direct_interpreter_eval = integer(0),
                            indirect_interpreter_eval = integer(0),
                            direct_c_call = integer(0),
                            indirect_c_call = integer(0),
                            direct_allocation = integer(0),
                            indirect_allocation = integer(0),
                            direct_writes = integer(0),
                            indirect_writes = integer(0),
    ...
    data.frame(eval_call_id                   = eval_call_id,
               ...
               caller_stack_expression        = caller_stack_expression,
               caller_stack_expression_raw    = caller_stack_expression_raw,
               caller_stack_expression_srcref = caller_stack_expression_srcref,
               ...
               indirect_builtin               = indirect_builtin,
               direct_special                 = direct_special,
               indirect_special               = indirect_special,
               direct_closure                 = direct_closure,
               indirect_closure               = indirect_closure,
               direct_interpreter_eval        = direct_interpreter_eval,
               indirect_interpreter_eval      = indirect_interpreter_eval,
               direct_c_call                  = direct_c_call,
               indirect_c_call                = indirect_c_call,
               direct_allocation              = direct_allocation,
               indirect_allocation            = indirect_allocation,
