...
static const R_CallMethodDef callMethods[] = {
    ...
    {"in_r_tracing", (DL_FUNC) &in_r_tracing, 1},
    {"get_builtin_call_entry_callback", (DL_FUNC) &r_get_builtin_call_entry_callback, 0},
    {"get_builtin_call_exit_callback", (DL_FUNC) &r_get_builtin_call_exit_callback, 0},
    {"get_special_call_entry_callback", (DL_FUNC) &r_get_special_call_entry_callback, 0},
    {"get_special_call_exit_callback", (DL_FUNC) &r_get_special_call_exit_callback, 0},
